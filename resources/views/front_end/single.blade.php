                    ...
                    <div class="comment-area my-5">
                        ...
                        @foreach ($post->comments as $comment)
                                ...
                                <div class="comment-area-box media mt-5 pt-4">                                
                                    <img src="{{asset('images/' . $comment->user->image)}}" class="float-left mr-3 mt-2 rounded-circle shadow" style="width: 100px; height: 100px">
                                ...
                                @foreach ($comment->replies as $reply)
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="col">
                                            <div class="d-flex">                                            
                                                <img src="{{asset('images/' . $reply->user->image)}}" class="float-left mr-3 mt-2 rounded-circle shadow" style="width: 100px; height: 80px">
                                    ...
                                    @foreach ($reply->replies as $doubleReply)
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col">
                                                <div class="d-flex">                                            
                                                    <img src="{{asset('images/' . $doubleReply->user->image)}}" class="float-left mr-3 mt-2 rounded-circle shadow" style="width: 100px; height: 80px">
                                        ...
                                        @foreach ($doubleReply->replies as $tripleReply)
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col">
                                                    <div class="d-flex">                                            
                                                        <img src="{{asset('images/' . $tripleReply->user->image)}}" class="float-left mr-3 mt-2 rounded-circle shadow" style="width: 100px; height: 80px">
